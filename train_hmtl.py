...
def train_epoch(model, train_loader, criterion, optimizer, device, 
    ...
    for batch in tqdm(train_loader, desc="Training", leave=False):
        ...
        # if batch_count == 0:
        #     print(f"\nDEBUG: Batch structure - len(batch): {len(batch)}")
        ...
        if len(batch) == 4:
            ...
            #     print(f"DEBUG: final_batch_targets shape: {final_batch_targets.shape}")
            #     print(f"DEBUG: intermediate_batch_targets shape: {intermediate_batch_targets.shape}")
            #     print(f"DEBUG: Expected intermediate targets: {intermediate_targets}")
            #     print(f"DEBUG: Expected final targets: {final_targets}")
